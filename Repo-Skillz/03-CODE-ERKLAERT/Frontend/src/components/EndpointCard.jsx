/* ═══════════════════════════════════════════════════════
 * 📦 ENDPOINT CARD (Tabellenzeile)
 *
 * 🎯 ZWECK:
 * Eine Zeile in der Monitor-Tabelle. Zeigt:
 * - Status-LED (grün/rot/grau)
 * - URL (editierbar)
 * - Uptime-Dauer
 * - Prüfintervall
 * - Sparkline (Mini-Chart der letzten 30 Checks)
 * - Letzter Change (Datum + Uhrzeit)
 * - Steuerung: Toggle, Interval, Log, Delete
 *
 * 🎓 LERN-TIPP:
 * Doppelklick auf die Zeile öffnet das Log-Modal.
 * Jeder Button hat seinen eigenen Event-Handler,
 * der nach oben gereicht wird (Props).
 * ═══════════════════════════════════════════════════════ */
