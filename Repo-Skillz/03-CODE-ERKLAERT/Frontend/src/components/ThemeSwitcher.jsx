 ...
 *
 * 🎯 ZWECK:
 * Dropdown-Menü zum Umschalten zwischen den drei Themes.
 * Nutzt ThemeContext (useTheme).
 *
 * 💡 KONZEPTE:
 * - Click-Outside schließen (useRef + mousedown)
 * - Context-Consumer (useTheme)
 * - Dropdown via useState(open)
 *
 * 🎓 LERN-TIPP:
 * Das Click-Outside-Pattern ist ein Standard in React:
 * 1. useRef auf Container
 * 2. mousedown-Event auf document
 * 3. Prüfen ob target außerhalb
 * ═══════════════════════════════════════════════════════ */
