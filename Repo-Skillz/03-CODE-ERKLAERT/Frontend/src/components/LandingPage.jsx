/* ═══════════════════════════════════════════════════════
 * 📦 LANDING PAGE (Login-Bildschirm)
 *
 * 🎯 ZWECK:
 * Hero-Screen mit Spaceship-Cockpit-Design.
 * Enthält Login-Formular und Link zur Registrierung.
 *
 * 💡 KONZEPTE:
 * - useRef für unkontrollierte Inputs
 * - CSS-Pseudoelemente für Scanlines + Grid
 * - HUD-Ring (SVG)
 * - Kein Controllable Pattern (useRef statt useState)
 *
 * 🎓 LERN-TIPP:
 * Die refs ersetzen useState für Form-Inputs – das ist
 * ein "uncontrolled components"-Pattern. Spart Code,
 * da wir die Werte nur beim Submit brauchen.
 * ═══════════════════════════════════════════════════════ */
